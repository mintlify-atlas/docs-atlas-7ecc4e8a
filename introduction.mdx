---
title: "Discord Rawrbot: Your Community Bot"
sidebarTitle: "Introduction"
description: "Discord Rawrbot is a feature-rich Discord bot built with discord.py, offering slash commands for moderation, music, translation, and server utilities."
---
...
| Music | `cogs.music` | Music playback and Spotify integration |
...
<CardGroup cols={2}>
  ...
  <Card title="Music Commands" icon="music" href="/commands/music">
    Music playback powered by yt-dlp, Spotify search via the Spotify Web API, and song.link cross-platform sharing.
  </Card>
...
- **`yt-dlp`** — required for music playback and the `/upload` command's download functionality
