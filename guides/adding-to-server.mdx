---
title: "Add Discord Rawrbot to Your Server"
sidebarTitle: "Adding to Server"
description: "Invite Discord Rawrbot to your Discord server or install it to your user account for DM and cross-server access."
---
