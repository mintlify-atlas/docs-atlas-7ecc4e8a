---
title: "Get Started with Discord Rawrbot"
sidebarTitle: "Quickstart"
description: "Set up and run Discord Rawrbot locally in minutes — clone the repo, install dependencies, add your config, and launch the bot."
---
