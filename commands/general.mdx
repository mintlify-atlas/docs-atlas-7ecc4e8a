---
title: "Rawrbot General Commands: Ping, Hello, Invite & More"
sidebarTitle: "General"
description: "General-purpose slash commands in Rawrbot: check latency, greet users, generate an invite link, enjoy /pop, and sync the command tree as the bot owner."
---
...
A lighthearted fun command. In a server, Rawrbot sends a short message with a pop fact. In a DM or Group DM (where `interaction.guild` is `None`), it appends a hidden spoiler tag containing a cheeky follow-up line — revealed only if you click to unblur it.
