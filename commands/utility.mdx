---
title: "Utility Commands: Translate, Images, and Uploads"
sidebarTitle: "Utility"
description: "Utility slash commands in Rawrbot: translate text across 25+ languages, find random images in a server, and upload videos to catbox.moe."
---
...
<ParamField path="optional_message" type="string">
  An optional text message to include alongside the uploaded file or catbox.moe link in the final response.
</ParamField>
